...
const done_button_for_no_of_students =
...
let inputs_container = document.getElementsByClassName(
...
function create_nodes(
  ...
  activate_button.addEventListener("click", (e) => {
    ...
    if (
      parseInt(input_field.value) === 0 ||
      parseInt(input_field.value) === parseInt("")
    ) {
    ...
    // CREATE A NEW DATA-ROW BASED ON THE NUMBER OF COURSES.
      ...
      for (i = 1; i <= parseInt(input_field.value); i++) {
        ...
        level_indicator.innerHTML = `${level_input_value.slice(
          0,
          3
        )} level ${department_of_students.value.toUpperCase()} students courses`;
...
function create_saved_record(
  container_for_records,
  student_level,
  student_department
) {
...
let get_close_button_for_courses = get_for_close(
  ".for-courses .close",
  ".for-courses .yes",
  ".for-courses .no",
  ".for-courses .confirm-closing"
);

let get_close_button_for_students = get_for_close(
  ".for-students .close",
  ".for-students .yes",
  ".for-students .no",
  ".for-students .confirm-closing"
);
...
let store_close_for_no_of_courses = object_for_close_btn(
  get_close_button_for_courses.actual_element(),
  get_close_button_for_courses.yes_btn(),
  get_close_button_for_courses.no_btn(),
  get_close_button_for_courses.modal_close()
);

let store_close_for_no_of_students = object_for_close_btn(
  get_close_button_for_students.actual_element(),
  get_close_button_for_students.yes_btn(),
  get_close_button_for_students.no_btn(),
  get_close_button_for_students.modal_close()
);

// CALLING THIS FUNCTION FOR EACH MODALS CLOSE BUTTONS.
// FOR THE NUMBER OF COURSES MODAL.
close_the_modal(
  store_close_for_no_of_courses.close_element,
  store_close_for_no_of_courses.modal_for_close,
  store_close_for_no_of_courses.yes,
  store_close_for_no_of_courses.no,
  modal_for_courses,
  ".for-courses tbody",
  table_body_for_no_of_courses
);
...
close_the_modal(
  store_close_for_no_of_students.close_element,
  store_close_for_no_of_students.modal_for_close,
  store_close_for_no_of_students.yes,
  store_close_for_no_of_students.no,
  modal_for_students,
  ".for-students tbody",
  table_body_for_no_of_students
);
